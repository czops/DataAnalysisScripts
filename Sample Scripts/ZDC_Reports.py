...
fields = ['FileName:', 'Process:', 'Workbar:', 'Part Number 1:', 'Qty 1:', 'Part Number 2:', 'Qty 2:','Part Number 3:', 'Qty 3:', 'Part Number 4:', 'Qty 4:', 'Part Number 5:', 'Qty 5:', 'Steps']
headers = ['FileName','Process','Workbar',  'Part Number 1', 'Qty 1', 'Part Number 2', 'Qty 2','Part Number 3', 'Qty 3', 'Part Number 4', 'Qty 4', 'Part Number 5', 'Qty 5', 'Steps']
...
def RemoveEmptyRows(list_of_csv):
    ...
    for file in list_of_csv:
        with open(file) as file_obj:
            ...
            steps_list = str(new_csv[14:(15+len(new_csv))])
